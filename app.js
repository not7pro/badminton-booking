// ===== Badminton Court Booking Tracker =====
...
(function () {
    ...
    function createBookingItem(booking) {
        ...
        const dateLabel = booking.date === getTodayString() ? 'Today' : formatDate(booking.date);
        ...
        div.innerHTML = `
            ...
            <button class="btn-delete" title="Remove booking" data-delete="${booking.id}">
    ...
    function updateCourtCards() {
        ...
        for (let court = 1; court <= 3; court++) {
            const courtBookings = bookings.filter(b => b.court === court && b.date === today);
